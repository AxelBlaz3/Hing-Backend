...
REPORT_RECIPE_COLLECTION = 'report_recipe'
BLOCK_COLLECTION_COLLECTION= 'block_user'
...
GET_BLOCK_USER_ENDPOINT =f'{ENDPOINT_PREFIX}/{USER_ENDPOINT_PREFIX}/block'
...
GET_REPORT_RECIPE_ENDPOINT=f'{ENDPOINT_PREFIX}/{RECIPE_ENDPOINT_PREFIX}/report'
